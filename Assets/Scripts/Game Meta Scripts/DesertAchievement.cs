...
public class DesertAchievement : MonoBehaviour
{
	...
	public class StarImage
	{
		...
		private DesertAchievement stars;
		public StarImage(DesertAchievement a, Image image)
		{
			starImage = image;
			stars = a;
		}
